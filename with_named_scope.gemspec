Gem::Specification.new do |s|
  ...
  s.files = ["README", "ChangeLog", "Rakefile", "test/test_helper.rb", "test/with_named_scope_test.rb", "test/test.sqlite3", "lib/with_named_scope.rb", "lib/patch_for_2_1_0.rb", "rails/init.rb"]
  s.has_rdoc = true
